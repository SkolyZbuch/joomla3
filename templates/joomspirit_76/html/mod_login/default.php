...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
	...
	<ul class="icon_login">
		<li>
			...
			<img src="templates/joomspirit_76/images/lost-pwd.gif" alt="lost password" title="<?php echo JText::_('MOD_LOGIN_FORGOT_YOUR_PASSWORD'); ?>" /></a>
		</li>
		<li>
			<a href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>">
			<img src="templates/joomspirit_76/images/lost-uname.gif" alt="lost uname" title="<?php echo JText::_('MOD_LOGIN_FORGOT_YOUR_USERNAME'); ?>" /></a>
		</li>
		<?php
		...
		<li>
			...
			<img src="templates/joomspirit_76/images/create-account.gif" alt="create account" title="<?php echo JText::_('MOD_LOGIN_REGISTER'); ?>" /></a>
		</li>
		<?php endif; ?>
	</ul>
